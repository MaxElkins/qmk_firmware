 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LCTR | LGUI | LAlt |LOWER | /Bkspc  /       \Space \  |RAISE |  [{  |  ]}  |  =+  |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
...
[_QWERTY] = LAYOUT( \
 ...
 C(S(KC_LALT)),   KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                     KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN,  KC_QUOT, \
        KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, _______,     _______,KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT, \
                        KC_LCTRL,KC_LGUI,KC_LALT, KC_LOWER, KC_BSPC,    KC_SPC,  KC_RAISE, KC_LBRC, KC_RBRC, KC_EQL \
),
...
[_LOWER] = LAYOUT( \
  ...
  KC_LSFT, _______, _______, _______, _______, _______,  _______,        _______, _______, _______, _______, _______, KC_BSLS, KC_RSFT, \
                    KC_LCTRL,KC_LGUI,KC_LALT, KC_LOWER, _______,        _______, KC_RAISE, _______, _______, KC_MINS \
),
...
[_RAISE] = LAYOUT( \
  ...
  KC_LSFT, _______, _______, _______, _______, _______, _______,       _______,  _______, _______, KC_LABK, KC_RABK, KC_QUES, KC_RSFT, \
                    KC_LCTRL,KC_LGUI,KC_LALT, KC_LOWER, _______,       _______, KC_RAISE, KC_LCBR, KC_RCBR, KC_PLUS \
),

...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT(
		...
		C(S(KC_LALT)),    KC_A,    KC_S,   KC_D,  KC_F,   KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,              MO(1),
		KC_LSFT, KC_Z,    KC_X,   KC_C,  KC_V,   KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_LSFT,      KC_UP,                        MO(2),
		KC_LCTL, KC_LGUI, KC_SPC, KC_LALT, KC_SPC, KC_LGUI,                                                 KC_LEFT, KC_DOWN, KC_RGHT),
	...
	[1] = LAYOUT(
		...
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_MNXT, KC_VOLD, KC_MPRV),
